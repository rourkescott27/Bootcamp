...
VALUES 
    ('Jasmine', 'Adams', 'F', '1527 South St', 'JasmineAdams@armyspy.com', 2,4,4,2),
	('Elise', 'Duffy', 'F', '1041 St. John Street', 'EliseDuffy@dayrep.com', 1,2,2,1),
	('Leo', 'Henderson', 'M', '1562 Gleemoor Rd', 'LeoHenderson@gmail.com', 4,7,7,4),
	('Emma', 'Griffin', 'F', '763 Burger St', 'EmmaGriffin@codecollege.co.za', 3,5,NULL,3), 
	('Josh', 'Hartley', 'M', '981 Broad Rd', 'JoshHartley@rhyta.com', 5,9,9,5),
	('Billy', 'Clarke', 'M', '1662 Dickens St', 'BillyClarke@teleworm.us', 6,11,11,6),
	('Maya', 'Sinclair', 'F', '1722 Bhoola Rd', 'MayaSinclair@teleworm.us', 2,3,3,NULL),
	('Amelia', 'Bailey', 'F', '15 Bodenstein St', 'AmeliaBailey@rhyta.com', 4,8,8,4),
    ('James', 'Hussain', 'M', '1820 Daffodil Dr', 'JamesHussain@rhyta.com', 5,10,10,5),
    ('Amber', 'Charlton', 'F', '989 Roger St', 'AmberCharlton@dayrep.com', 3,6,6,3),
	('David', 'Young', 'M', '686 Amos St', 'DavidYoung@rhyta.com', 6,NULL,12,6),
	('Charlotte', 'Hamilton', 'F', '2218 Oranje St', 'CharlotteHamilton@gmail.com',1,1,1,1);
