...
FROM 'C:\Users\Rourke Scott\Desktop\postgresql\practical-sql-main\Chapter_10\acs_2011_2015_stats.csv'
...
FROM 'C:\Users\Rourke Scott\Desktop\postgresql\practical-sql-main\Chapter_10\fbi_crime_data_2015.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
...
--Try it yourself 1
SELECT round(
		corr(pct_masters_higher, median_hh_income)::numeric, 2
)AS masters_income_r,
		round(
		corr(pct_bachelors_higher, median_hh_income)::numeric, 2
)AS bachelors_income_r
FROM acs_2011_2015_stats;
...
motor_vehicle_theft, 
round(
	(motor_vehicle_theft::numeric / population) * 100, 1
...
violent_crime,
round(
	(violent_crime::numeric / population) * 100, 1
