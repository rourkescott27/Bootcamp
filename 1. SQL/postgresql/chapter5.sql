...
FROM us_counties_2010)
TO 'C:\Users\Rourke Scott\Desktop\postgresql\practical-sql-main\Chapter_05\total_white_total_black.txt'
...
--try it yourself 1
SELECT 3.14 * (5 ^ 2) AS circle_area;
...
--Combine the 2 queries to shorten the code
