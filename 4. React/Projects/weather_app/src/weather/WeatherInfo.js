            ...
            <div className="weather-info text-center card bg-light">
                ...
                <i className="bi bi-cloud-haze text-center display-2 text-warning"></i>
                {
                    typeof weatherData.main == "undefined" ? (
                        ...
                        <>
                            <h3>{weatherData.main.temp}<sup>o</sup> C</h3>
                            <hr />
                            <div className="row">
                                <div className="col-sm-4">{weatherData.main.temp_max}<sup>o</sup> C<br /><b>Max Temp</b></div>
                                <div className="col-sm-4">{weatherData.main.temp_min}<sup>o</sup> C<br /><b>Min Temp</b></div>
