...
const express = require("express"),
  ...
  //** 24.1) Requiring and initializing passport
...
// ** 24.2) Setting up passport serializing
const User = require("./models/user");
passport.use(User.createStrategy());
// These 2 lines tells passport to serialise your users through the User model.
