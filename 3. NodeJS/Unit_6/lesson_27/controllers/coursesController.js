...
module.exports = {
    ...
    // 27.2) Adding JSON responses for courses
    respondJSON: (req, res) => {
        res.json({
            status: httpStatus.OK,
            // Responds with local data in JSON format
            data: res.locals
        });
    },
    // Responds with a 500 status code and error message in JSON format
    ...
    // 27.6) Creating an action to join a course
    ...
    // 27.7) Adding an action to filter courses
